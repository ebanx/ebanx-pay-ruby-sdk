...
require_relative 'ebanx/command/whitelisted_commands'
...
module Ebanx
  ...
  def self.run_command(method, params)
    ...
    raise NoMethodError unless Ebanx::Command::WHITELISTED_COMMANDS.include? command.class
  ...
  def self.get_command_class(method)
    ...
    class_name = 'Ebanx::Command::' + method.split('_').map(&:capitalize).join
